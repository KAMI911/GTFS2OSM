...
class POI_address(Base):
    ...
    poi_osm_id = Column(Integer, index=True)
    poi_name = Column(Unicode, nullable=False, index=True)
    poi_branch = Column(Unicode, nullable=True, index=True)
    ...
    poi_city = Column(Unicode)
    poi_addr_street = Column(Unicode)
    poi_addr_housenumber = Column(Unicode)
    poi_conscriptionnumber = Column(Unicode)
    original = Column(Unicode)
    poi_website = Column(Unicode)
